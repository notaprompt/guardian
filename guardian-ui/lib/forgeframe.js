 ...
 *
 * @param {import('better-sqlite3').Database} database - open DB handle
 */
 ...
 *
 * @param {string} tier - 'quick', 'balanced', or 'deep'
 * @returns {{ id: string, provider: string, tier: string } | null}
 */
 ...
 * @returns {{ provider: string, modelId: string, tier: string, auto: boolean }}
 */
